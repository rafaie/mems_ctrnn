...
for (i in c(1:length(vars$X2)) ){
  #i = 1
  opt = vars[i,]
  data_5 = base_data[base_data$X2 == opt$X2 & base_data$Y2==opt$Y2 & base_data$step_size == 0.1
                  & base_data$obj_type == 1, ]
  ...
  data_6 = base_data[base_data$X2 == opt$X2 & base_data$Y2==opt$Y2 & base_data$step_size == 0.1
                  & base_data$obj_type == 2, ]
