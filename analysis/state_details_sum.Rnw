...
for (i in c(1:nrow(vars)) ){
  ...
  data_3_1 = melt(data_3[,c(2,3, 14:ncol(base_data)-1)], id=c(1,2))
  g1<-
    ggplot(data_3_1, aes(timer, value)) +
    ...
    facet_grid(variable~step_size) + theme_light(base_size = 8) + 
